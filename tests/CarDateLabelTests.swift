...
struct CarDateLabelTests {
    static func main() {
        ...
        assert(label("2026-09-17T09:00:00+01:00") == "Thursday 17")
        assert(label("2026-09-16T18:15:00+01:00") == "Wednesday 16")
        assert(label("2026-09-15T17:42:00+01:00") == "Tuesday 15")
        assert(label("2026-09-14T18:15:00+01:00") == "Monday 14")
        assert(label("2026-09-11T00:00:00+01:00") == "Friday 11")
        ...
        assert(label("2026-09-18T09:00:00+01:00", at: date("2026-09-18T14:00:00+01:00")) == "Friday 18")
        // Last-year dates still get a weekday when they fall within seven days.
        assert(label("2025-12-31T23:30:00Z", at: date("2026-01-01T08:00:00Z")) == "Wednesday 31")
        ...
        assert(label("2026-10-19T00:00:00+01:00", at: date("2026-10-25T23:59:00Z")) == "Monday 19")
        print("13 UI date-label checks passed; no app or terminal code was loaded.")
    }
}
